...
```
pip install dist/nomad-parser-yambo-0.0.1
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-parser-yambo" is free and open source software
